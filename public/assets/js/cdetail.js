...
document.getElementById('view-ytb').addEventListener('click',function () {
    document.getElementById('open-video').style.display = 'flex'
})

document.getElementById('xmar').addEventListener('click',function () {
    document.getElementById('open-video').style.display = 'none '
})
