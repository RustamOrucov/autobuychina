    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="bs-stepper-content">
                <h5 style="margin-bottom: 15px" class="mb-1">Static Translations</h5>
                            ...
                            <div class="col-sm-12">
                                <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc">Static 1</th>
                                        <th class="sorting_asc">Static 2</th>
                                        <th class="sorting_asc">Static 3</th>
                                        <th class="sorting_asc">Static 4</th>
