...
@section('content')
    ...
    <input value="{{ old($lang.'title', isset($model) ? optional($model->translateOrDefault($lang))->title : '') }}" type="text" class="form-control" id="Title" placeholder="Static 1" name="{{ $lang }}[title]">
    @error("$lang.title")
...
<div class="col-12 col-lg-6">
    ...
    <input value="{{ old($lang.'text', isset($model) ? optional($model->translateOrDefault($lang))->text : '') }}" type="text" class="form-control" id="text" placeholder="Static 2" name="{{ $lang }}[text]">
    @error("$lang.text")
    <span class="text-danger">{{ $message }}</span>
    @enderror
</div>
<div class="col-12 col-lg-6">
    ...
    <input value="{{ old($lang.'desc', isset($model) ? optional($model->translateOrDefault($lang))->desc : '') }}" type="text" class="form-control" id="desc" placeholder="Static 3" name="{{ $lang }}[desc]">
    @error("$lang.desc")
    <span class="text-danger">{{ $message }}</span>
    @enderror
</div>
<div class="col-12 col-lg-6">
    ...
    <input value="{{ old($lang.'name', isset($model) ? optional($model->translateOrDefault($lang))->name : '') }}" type="text" class="form-control" id="Name" placeholder="Static 4" name="{{ $lang }}[name]">
    @error("$lang.name")
    <span class="text-danger">{{ $message }}</span>
    @enderror
</div>
