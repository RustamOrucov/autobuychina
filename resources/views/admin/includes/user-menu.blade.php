    ...
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand gap-3">
            <div class="topbar-logo-header d-none d-lg-flex">
                <div class="">
                    <img src="{{asset('_assets/images/150503209-simple-car-auction-logo-with-hammer-vector-in-round-frame-for-icon-or-clip-art-picture-mark-design.jpg')}}" class="logo-icon" alt="logo icon">
                </div>
                <div class="">
                    <h4 class="logo-text">Auction</h4>
                </div>
            </div>
