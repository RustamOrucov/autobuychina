    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="bs-stepper-content">
                <h5 style="margin-bottom: 15px" class="mb-1">Alt Kateqoriyalar</h5>
                            ...
                            <div class="col-sm-12">
                                <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc">Sub Category Name</th>
                                    ...
                                    @foreach($models  as $model)
                                        <tr role="row" class="even">
                                            ...
                                            <td>{{$model->name}}</td>
                                            <td>{{ $model->category ? $model->category->translateOrDefault(app()->getLocale())->name : '' }}</td>
                                            <td>
                                                @if($model->status == 1)
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.position-change').forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    fetch(`/admin/subcategory/change-position/${subcategoryId}`, {
                        method: 'POST',
                        headers: {
