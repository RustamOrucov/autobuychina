...
@section('content')
    <?php  $routeName='admin.market' ?>


    <div class="card">
        <div class="card-body">
            <a href="{{ route($routeName.'.create') }}" style="margin-bottom: 15px" type="button" class="btn btn-light px-5 radius-30"><i class="lni lni-plus"></i>New Add</a>
            <div class="bs-stepper-content">
                <h5 style="margin-bottom: 15px" class="mb-1">Market</h5>
                            ...
                            <div class="col-sm-12">
                                <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc">Market Name</th>
