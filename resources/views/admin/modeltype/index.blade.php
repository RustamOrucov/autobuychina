    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="bs-stepper-content">
                <h5 style="margin-bottom: 15px" class="mb-1">Avtomobil Model Type</h5>
                            ...
                            <div class="col-sm-12">
                                <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc">Model Type Name</th>
                                        <th class="sorting_asc">Car Model Name</th>
                                    ...
                                    @foreach($models as $model)
                                        <tr role="row" class="even">
                                            ...
                                            <td>{{ $model->name }}</td>
                                            <td>{{ $model->carModel ? $model->carModel->name : 'ID: ' . $model->car_models_id }}</td>
                                            ...
                                            <td>
                                                <form class="delete-form" action="{{ route($routeName . '.destroy', $model->id) }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button style="background-color: #fff; border: none" class="btn btn-danger">
                                                        <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
                                                        <lord-icon src="https://cdn.lordicon.com/jmkrnisz.json" trigger="hover" colors="primary:#121331" style="width:25px; height:25px"></lord-icon>
                                                    </button>
                                                </form>
                                            </td>
                                        </tr>
