...
@section('mobile_content')
    <div class="body-inner" style="">
        ...
        <div class="content">
            <div class="product product--bordered">
                ...
                <div class="product-photos">
                    ...
                    <div class="reveal-modal product-gallery js-product-gallery tz-d-flex"
                        ...
                        <div class="product-gallery__header tz-justify-between tz-d-flex tz-align-center">
                            ...
                            <div class="product-gallery__bookmarking"><a
                                    class="product-gallery__bookmarking-link product-gallery__bookmarking-link--full added hide js-unbookmark-item-8801633"
                                    data-remote="true" rel="nofollow" data-method="delete"
                                    href="/autos/8801633-bmw-328/bookmarks">Seçilmişlərdədir</a><a
                                    class="product-gallery__bookmarking-link product-gallery__bookmarking-link--empty js-bookmark-item-8801633"
                ...
                <div class="product-section product-header">
                    <div class="tz-d-flex">
                        <div class="product-price">
                            <div class="product-price__i product-price__i--bold">31 200 AZN</div>
                        </div>
                    </div>
                    <h1 class="product-name">BMW 328, <span class="nobr">2.0 L</span>, <span class="nobr">2013
                            il</span>, <span class="nobr">118 000 km</span></h1>
                </div>
                ...
                <ul class="product-properties product-section product-table">
                    <li class="product-table__row">
                        <div class="product-table__row-name">Şəhər</div>
                        <div class="product-table__row-value">Lənkəran</div>
                    </li>
                    <li class="product-table__row">
                    ...
                    <li class="product-table__row">
                        <div class="product-table__row-name">Ban növü</div>
                        <div class="product-table__row-value">Sedan</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Rəng</div>
                        <div class="product-table__row-value">Ağ</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Mühərrik</div>
                        <div class="product-table__row-value">2.0 L / 245 a.g. / Benzin</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Yürüş</div>
                        <div class="product-table__row-value">118 000 km</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Sürətlər qutusu</div>
                        <div class="product-table__row-value">Avtomat</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Ötürücü</div>
                        <div class="product-table__row-value">Arxa</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Yeni</div>
                        <div class="product-table__row-value">Xeyr</div>
                    </li>
                    <li class="product-table__row">
                        <div class="product-table__row-name">Hansı bazar üçün yığılıb</div>
                        <div class="product-table__row-value">Amerika</div>
                    </li>
                    <li class="product-table__row">
                    ...
                    <li class="product-table__row">
                        ...
                        <div class="product-table__row-value">Vuruğu yoxdur, rənglənməyib</div>
                    </li>
                </ul>
                <div class="product-divider"></div>
                <div class="product-section">
                    <div class="product-vin">
                        <div class="tz-d-flex tz-align-center">
                            <div class="product-vin__title">VIN-kod:<span class="js-copy-text">WBA3C1G5XDNR48617</span>
                            </div>
                            <div class="product-vin__copy">
                                <div class="product-vin__copy-icon js-copy-icon"></div>
                ...
                <section class="product-section">
                    <div class="product-description-container js-description-container is-expanded"><input
                            ...
                            for="description-btn">Davamını oxu</label>
                        <div class="product-description__content js-description-content">
                            <p>BMW 328 i 2013
                                <br>2.0 Turbo N26 mühərrik
                                <br>- Full M Paket
                                <br>- Led Adaptiv faralar (original )
                                <br>- Lyuk
                                <br>- Keyles go (əl izi ilə qapıların açılması)
                                <br>- Keyles ayaq jesti ilə baqajın açılması
                                <br>- M3 Body Kit
                                <br>- Arxa M3 spoiler
                                <br>- katalizatorlar ustundedi
                                <br>- M3 CS exhaust başliqlari
                                <br>- Start/Stop
                                <br>- Eco Pro / Comfort / Sport / Sport Plus
                                <br>- -Aux / CD / Navigator / Bluetooth
                                <br>- Yağiş və işiğ sensoru
                                <br>- Hed Up displey
                                <br>- Ambiance işiqlari
                                <br>- Böyuk monitor
                                <br>- Böyuk jostik
                                <br>- Qara dam örtuyu (tavan)
                                <br>- Acces comfort
                                <br>- Oturacaq qizdiricilari
                                <br>- M Güzgü qapaqlari
                                <br>- Yalniz 95 oktanli benzin ilə sürülüb. 92 ilədə sürmək mümkündür.
                                <br>- Sep başmaq (original BMW group) əvəz olunub.
                                <br>- Arxa çəkəndi , Xüsusi öz zövqümə uyğun yiğmişam , Avtomobilə 2 göz lazimdi
                                baxilsin , cox sveji ideal səliqəli maşin di.
                                <br>- Hal hazirda qətiyyən manat belə xərc tələb etmir , mator karobka xadavoy kasmetika
                                ideal vəzziyətdə.
                            </p>

                            <p>VİN KOD: WBA3c1g5xdnr48617 maşın 2 ildi xaricdən sadəcə bufər zədəsi ilə gəlib. Vini tər
                                təmizdi baxa bilərsiniz. TƏCİLİ SATILMIR, ÖZÜNƏ İDEAL F30 AXATARANLAR YIĞA BİLƏR.</p>

                            <p>Maşını Salyan, hacıoğluna qədər gətirə bilərəm. Baxmaq istəyənlər orda baxa bilər.</p>
                        </div>
                    </div>
                </section>
                <div class="product-divider"></div>
                <section class="product-section product-section--wide">
                    <ul class="product-extras tz-d-flex tz-align-center tz-gap-10 tz-wrap-wrap">
                        ...
                        <li class="product-extras__i">Yağış sensoru</li>
                        <li class="product-extras__i">Kondisioner</li>
                        <li class="product-extras__i">Oturacaqların isidilməsi</li>
                        <li class="product-extras__i">Dəri salon</li>
                    </ul>
                </section>
                <div class="product-divider"></div>
                <div class="product-section">
                    <div class="product-owner tz-d-flex tz-align-center tz-justify-between">
                        <div class="product-owner__info">
                            <div class="product-owner__info-name">Sahib</div>
                            <div class="product-owner__info-region">Lənkəran</div>
                        </div>
                    ...
                    <div class="product-warning tz-d-flex tz-align-center tz-justify-between tz-gap-15">
                        <div class="product-warning__text"><span class="attention">Diqqət!</span> Avtomobilə baxış
                            keçirmədən öncə beh göndərməyin.</div>
                    </div>
                </div>
                <div class="product-divider"></div>
                <section class="product-section product-statistics product-table">
                    <div class="product-table__row">
                        <div class="product-table__row-name">Elanın nömrəsi</div>
                        <div class="product-table__row-value">8801633</div>
                    </div>
                    <div class="product-table__row">
                        <div class="product-table__row-name">Baxışların sayı</div>
                        <div class="product-table__row-value">972</div>
                    </div>
                    <div class="product-table__row">
                        <div class="product-table__row-name">Yeniləndi</div>
                        <div class="product-table__row-value">23.09.2024</div>
                    </div>
                </section>
                <div class="reveal-modal reveal-modal_service pin-recovery">
                    <div class="reveal-modal-popup">
                        <div class="title">PIN-şifrənin bərpası<div class="close-reveal-modal"></div>
                        </div>
                        <div class="reveal-modal--content">
                            ...
                            </div><a class="return" href="/autos/8801633-bmw-328">Geri</a>
                        </div>
                    </div>
                </div>
                <div class="product-actions product-actions--bordered">
                        ...
                        <div class="tz-modal">
                            <div class="tz-modal__header tz-d-flex tz-align-center tz-justify-center">
                                <div class="tz-modal__header-left"><span
                                        class="tz-modal__header-back js-close-modal"></span></div>
                                <div class="tz-modal__header-title">Elanın PIN-kodunu daxil edin</div>
                                <div class="tz-modal__header-right"></div>
                            </div>
                            <div class="tz-container">
                                <div class="action-modal__error js-pincode-error is-hidden"></div>
                                <div class="action-modal__description">PIN-kod elanı yerləşdirərkən qeyd etdiyiniz email
                                    ünvanına göndərilib.</div>
                                <div class="action-modal__title">BMW 328, <span class="nobr">2.0 L</span>, <span
                    ...
                    <div class="reveal-modal tz-confirm-modal js-pin-recovery-success" id="pin-recovery-success">
                        <div class="tz-confirm-modal__body">
                            <div class="tz-confirm-modal__title">Xidmət ödənildi</div>
                            <div class="tz-confirm-modal__text">PIN-kod elanda göstərilən telefon nömrəsinə göndərildi.
                            </div>
                        </div>
                        <div class="tz-confirm-modal__footer">
                            <div class="tz-confirm-modal__btn js-ok-btn">Aydındır</div>
                        </div>
                    </div>
                    <div class="reveal-modal tz-confirm-modal js-pin-recovery-confirm" id="pin-recovery-confirm">
                        <div class="tz-confirm-modal__body">
                            <div class="tz-confirm-modal__title">Hazırdır!</div>
                            <div class="tz-confirm-modal__text">PIN-kod elanda göstərilən email ünvanına göndərildi.
                            </div>
                        </div>
                        <div class="tz-confirm-modal__footer">
                            <div class="tz-confirm-modal__btn js-ok-btn">Aydındır</div>
                    ...
                    <div class="reveal-modal reveal-modal--full-height action-modal js-pin-recovery-modal"
                        ...
                        <div class="tz-modal tz-modal--grey">
                            <div class="tz-modal__header tz-d-flex tz-align-center tz-justify-center">
                                <div class="tz-modal__header-left"><span
                                        class="tz-modal__header-back js-return-back"></span></div>
                                <div class="tz-modal__header-title">Elanın PIN-kodunun bərpası</div>
                                <div class="tz-modal__header-right"></div>
                            </div>
                            <div class="tz-modal__blk tz-modal__blk--text tz-modal__text">Elanın PIN-kodunu SMS (1 AZN)
                                və ya email (ödənişsiz) vasitəsilə əldə edə bilərsiniz. Bunun üçün elanda göstərilən
                                telefon nömrəsini və ya email ünvanını qeyd etməlisiniz.</div>
                            <div class="tz-modal__divider"></div>
                            ...
                            <form class="email-form js-email-form is-hidden" action="/autos/8801633-bmw-328/resend_pin"
                                ...
                                <div class="tz-modal__blk tz-modal__blk--top-border">
                                    ...
                                    <div class="error action-modal__error is-hidden"></div>
                                    <div class="tz-container"><label class="action-modal__label">Email</label><input
                                            type="text" name="email" id="email"
                                            class="tz-modal__input tz-modal__input--bottom-border js-non-empty-input"
                                            maxlength="60"></div>
                                </div>
                ...
                <div class="reveal-modal tz-confirm-modal js-report-success">
                    <div class="tz-confirm-modal__body">
                        <div class="tz-confirm-modal__title">Şikayətiniz göndərildi</div>
            ...
            <div class="tz-section">
                ...
                <div class="products tz-section__list">
                    <div class="products-i"><a class="products-i__link" target="_self"
                        ...
                        <div class="products-i__bottom">
                            <div class="products-i__price products-i__bottom-text">
                                <div class="product-price">32 800 <span>AZN</span></div>
                            </div>
                            <div class="products-i__name products-i__bottom-text">BMW 328</div>
                            <div class="products-i__attributes products-i__bottom-text">2016, 2.0 L, 161 000 km</div>
                            <div class="products-i__datetime">Bakı, bugün 14:49</div>
                        </div>
                    </div>
                    <div class="products-i salon"><a class="products-i__link" target="_self"
                        ...
                        <div class="products-i__bottom">
                            <div class="products-i__price products-i__bottom-text">
                                <div class="product-price">34 500 <span>AZN</span></div>
                            </div>
                            <div class="products-i__name products-i__bottom-text">BMW 328</div>
                            <div class="products-i__attributes products-i__bottom-text">2015, 2.0 L, 144 000 km</div>
                            <div class="products-i__datetime">Bakı, bugün 14:29</div>
                        </div>
                    </div>
                    <div class="products-i vipped"><a class="products-i__link" target="_self"
                        ...
                        <div class="products-i__bottom">
                            <div class="products-i__price products-i__bottom-text">
                                <div class="product-price">26 900 <span>AZN</span></div>
                            </div>
                            <div class="products-i__name products-i__bottom-text">BMW 328</div>
                            <div class="products-i__attributes products-i__bottom-text">2014, 2.0 L, 370 149 km</div>
                            <div class="products-i__datetime">Bakı, bugün 14:26</div>
                        </div>
                    </div>
                    <div class="products-i vipped featured"><a class="products-i__link" target="_self"
                        ...
                        <div class="products-i__bottom">
                            <div class="products-i__price products-i__bottom-text">
                                <div class="product-price">23 900 <span>AZN</span></div>
                            </div>
                            <div class="products-i__name products-i__bottom-text">BMW 328</div>
                            <div class="products-i__attributes products-i__bottom-text">2013, 2.0 L, 183 465 km</div>
                            <div class="products-i__datetime">Bakı, bugün 14:24</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="tz-divider"></div>
            <div class="tz-section">
                <div class="tz-section__title tz-d-flex tz-justify-between tz-align-center"><a
                        href="https://tap.az/elanlar/neqliyyat/ehtiyyat-hisseleri-ve-aksesuarlar" target="_blank">
            ...
            <div class="tz-section">
                <div class="tz-section__title tz-d-flex tz-justify-between tz-align-center"><a
                        href="https://tap.az/elanlar/elektronika/telefonlar" target="_blank">
            ...
            <div class="tz-divider"></div>
            <div class="reveal-modal reveal-modal_service js-reveal-modal-service" id="pin_recovery_modal">
                <div class="reveal-modal-popup">
                    <div class="reveal-modal--content">
                        <div class="close-reveal-modal"></div>
                        <div class="payment-providers payment-providers_visible">
                            <div class="title">PIN-şifrənin bərpası</div>
                            <div class="payment-form-container" data-price="1">
                                <div class="description">
                                    <p>PIN-şifrəni SMS vasitəsilə əldə etmək.</p>
                                    <p>Xidmətin qiyməti - <b>1 AZN</b>.</p>
                                </div>
                                <div class="az-payments-type-yigim" id="yigim"><label class="providers-radio"><input
                                            type="radio" name="payment_provider" id="payment_provider_yigim"
                                            value="yigim" data-href="/yigim"><span class="radio-label">Bank
                                            kartı</span><span
                                            class="digital-payment-provider digital-payment-provider--google-pay"></span></label>
                                </div>
                        ...
                        <div class="thank-you">
                            ...
                            <p id="pin_recovery">PIN-şifrə (070) 540-34-94 nömrəsinə göndərildi.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="reveal-modal terminal-modal services-modal" id="terminal-promotion-modal">
                <div class="tz-modal tz-modal--grey">
                    <div class="tz-modal__header tz-d-flex tz-align-center tz-justify-center">
                        <div class="tz-modal__header-left"><span
                                class="tz-modal__header-close js-terminal-back-btn"></span></div>
                        <div class="tz-modal__header-title">Terminallarda ödəniş</div>
                        <div class="tz-modal__header-right"></div>
                    </div>
                    <div class="tz-modal__blk tz-modal__blk--text terminal-modal__top">
                        <div class="terminal-modal__top-title tz-modal__text tz-modal__text--dark">Sizin BMW 328
                            elanınızın nömrəsi</div>
                        <div class="terminal-modal__top-number tz-d-flex tz-align-center tz-justify-center">8801633
                        </div>
                    </div>
                    <div class="tz-modal__divider"></div>
                    <div class="terminal-modal__content tz-modal__blk tz-modal__blk--top-border">
                        <div class="terminal-modal__blk terminal-modal__steps">
                            <div class="terminal-modal__steps-title tz-modal__text--dark tz-modal__text--bold">eManat,
                                MilliÖn, Kapital Bank, ExpressPay, Keşpay və ya Kassam ödəniş terminallarından birinə
                                yaxınlaşın</div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Müvafiq
                                bölməni seçin:<ul>
                                    <li class="tz-modal__text tz-modal__text--dark">
                                        <div class="logo logo--emanat"></div>eManat terminalında «Mağazalar şəbəkəsi və
                                        e-ticarət»
                                    </li>
                                    <li class="tz-modal__text tz-modal__text--dark">
                                        <div class="logo logo--million"></div>MilliÖn terminalında «Elanlar və kuponlar»
                                    </li>
                                    <li class="tz-modal__text tz-modal__text--dark">
                                        <div class="logo logo--kapital"></div>Kapital Bank terminalında «Digər
                                        ödənişlər»
                                    </li>
                                    <li class="tz-modal__text tz-modal__text--dark">
                                        <div class="logo logo--express"></div>ExpressPay terminalında «Digər xidmətlər»
                                    </li>
                                    <li class="tz-modal__text tz-modal__text--dark">
                                        <div class="logo logo--kassam"></div>Kassam terminalında «Digər»
                                    </li>
                                    <li class="tz-modal__text tz-modal__text--dark">
                                        <div class="logo logo--kespay"></div>Keşpay terminalında «Elanlar və kuponlar»
                                    </li>
                                </ul>
                            </div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Açılan
                                bölmədə «Turbo.az»-ı seçin</div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Elanınızın
                                nömrəsini daxil edin - <span>8801633</span>, «İrəli» düyməsini sıxın</div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Elan
                                məlumatlarının düzgünlüyünə əmin olun</div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Siyahıdan
                                lazım olan xidməti seçin</div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Tələb
                                olunan məbləği terminalın əsginas qəbuledicisinə daxil edin, «İrəli» düyməsini sıxın
                            </div>
                            <div class="terminal-modal__steps-i tz-modal__text--medium tz-modal__text--dark">Qəbzin çap
                                olunmasını gözləyin.</div>
                        </div>
                        <div class="terminal-modal__blk tz-d-flex tz-align-center">
                            <div class="terminal-modal__icon terminal-modal__icon--wallet"></div>
                            <div class="tz-modal__text tz-modal__text--dark">Ödənişi həmçinin bank tətbiqləri və
                                elektron pul kisələri üzərindən həyata keçirə bilərsiniz: <span
                                    class="tz-d-flex tz-modal__text--medium">ExpressPay Wallet, PASHA Mobile Bank, Yelo
                                    Bank, E-pul, CIB.az</span></div>
                        </div>
                    ...
                    <div class="tz-modal__btn-container">
                        <div class="tz-btn tz-btn--full tz-btn--blue js-terminal-back-btn">Aydındır</div>
                    </div>
                </div>
            </div>
            <div class="reveal-modal profile-wallet-modal" id="js-profile-wallet-replenishment">
                <div class="reveal-modal-popup">
                    <div class="close-modal"></div>
                    <div class="reveal-modal--content">
                        <div class="profile-wallet_replenishment" id="js-profile-wallet-replenishment">
                                    ...
                                    <div class="az-payments-form az-payments-form-yigim" data-provider="yigim"
                                        ...
                                        <form class="new_payment" id="3addc038092febfc8eb6f0a751d9560e_new_payment"
                                            ...
                                            data-gtm-form-interact-id="3"><input type="hidden" name="authenticity_token"
                                                ...
                                                name="payment[source]"
                                                id="3addc038092febfc8eb6f0a751d9560e_payment_source"><input
                                                autocomplete="off" type="hidden" value="User"
                                                name="payment[target_type]"
                                                id="3addc038092febfc8eb6f0a751d9560e_payment_target_type"><input
                                                autocomplete="off" type="hidden" value="2123715"
                                                name="payment[target_id]"
                                                id="3addc038092febfc8eb6f0a751d9560e_payment_target_id">
                                            <div class="reveal-service">XİDMƏTİN MÜDDƏTİNİ SEÇİN</div>
                                            ...
                                            <div class="az-payments-type">
                                                ...
                                                <div class="az-payments-form-i portmanat"><input
                                                        class="az-payments-type-input"
                                                        data-tab=".az-payments-form-portmanat" type="radio"
                                                        value="portmanat" name="payment[payment_provider]"
                                                        id="3addc038092febfc8eb6f0a751d9560e_payment_payment_provider_portmanat"><label
                                                        for="3addc038092febfc8eb6f0a751d9560e_payment_payment_provider_portmanat">Portmanat</label>
                                                </div>
                                                <div class="az-payments-type-terminal">
                                                    <div class="az-payments-form-i js-payment-in-terminals-btn"><span
                                                            class="az-payments-form-i__info-icon"></span><label
                                                            class="providers-radio payment-in-terminals">Terminallarda
                                                            ödəniş</label></div>
                                                </div>
                                            </div>
                                            <div class="terms">
                                    ...
                                    <div class="az-payments-form az-payments-form-portmanat" data-provider="portmanat"
                                        ...
                                        <form class="new_payment" id="45ef8feb4435f92d8136d9e632bc7390_new_payment"
                                            action="/portmanat" accept-charset="UTF-8" method="post"><input
                                                ...
                                                autocomplete="off" type="hidden" value="User"
                                                name="payment[target_type]"
                                                id="45ef8feb4435f92d8136d9e632bc7390_payment_target_type"><input
                                                autocomplete="off" type="hidden" value="2123715"
                                                name="payment[target_id]"
                                                id="45ef8feb4435f92d8136d9e632bc7390_payment_target_id">
                                            <div class="reveal-service">XİDMƏTİN MÜDDƏTİNİ SEÇİN</div>
                                            <div class="custom-amount-service">
                                                <div class="custom-amount-service_title">Artırılacaq məbləğ, AZN</div>
                                                <input type="tel" name="amount_custom"
                                            ...
                                            <div class="az-payments-type">
                                                ...
                                                <div class="az-payments-form-i portmanat"><input
                                                        ...
                                                        data-tab=".az-payments-form-portmanat" type="radio"
                                                        value="portmanat" name="payment[payment_provider]"
                                                        id="45ef8feb4435f92d8136d9e632bc7390_payment_payment_provider_portmanat"><label
                                                        for="45ef8feb4435f92d8136d9e632bc7390_payment_payment_provider_portmanat">Portmanat</label>
                                                </div>
                                                <div class="az-payments-type-terminal">
                                                    <div class="az-payments-form-i js-payment-in-terminals-btn"><span
                                                            class="az-payments-form-i__info-icon"></span><label
            ...
            <div class="replenishment-request">
                <div class="reveal-modal-popup">
                    <div class="reveal-content">
                        <div class="replenishment-request__title">Diqqət!</div>
                        <div class="replenishment-request__description">Şəxsi hesabınızda kifayət qədər məbləğ yoxdur.
                            Zəhmət olmasa, balansınızı artırın.</div>
                        <div class="replenishment-request__buttons">
                            <div class="replenishment-request__close" id="js-replenishment-popup-close-btn">Bağla</div>
                            <div class="replenishment-request__confirm" id="js-replenishment-popup-btn">Balansı artır
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="reveal-modal-replenish-request-bg"></div>
        </div>
        <footer class="footer">
