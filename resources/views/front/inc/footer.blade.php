<footer class="footer">
    <div class="tz-container footer__blk--bordered footer__app-promotion">
        <div class="footer__app-promotion-left">
            <h2 class="promotion-title">Hər şey bir tətbiqdə!</h2>
            <div class="promotion-buttons"><a data-stat="app-store-footer-btn" class="footer__app-store-btn"
                    href="https://apps.apple.com/az/app/turbo-az/id1188237984"><img alt="App Store"
                    ...
                    data-stat="google-play-footer-btn" class="footer__app-store-btn"
                    href="https://play.google.com/store/apps/details?id=org.turboaz.android&amp;hl=az"><img
                        alt="Google Play"
                        src="https://turbo.azstatic.com/assets/application/footer/google-play-1fa43429df859cdd371c9631c5f47577e9c45a21cb7193dde48b896ae2b305af.png"></a><a
                    data-stat="app-gallery-footer-btn" class="footer__app-store-btn"
                    href="https://appgallery.huawei.com/app/C103829417"><img alt="App Gallery"
                        src="https://turbo.azstatic.com/assets/application/footer/app-gallery-f4e0bbe0ca62bd9def8cca44ce4d1b0f5c5dbabae25508a0ada0212c6e0e7c2d.png"></a>
            </div>
        </div>
        <div class="footer__app-promotion-right">
            <div class="footer__promotion-image"><img alt="" class="footer__phone-image"
            ...
            <div class="footer__qr-code"><img alt="QR Code" class="footer__qr-code-image"
                    ...
                    class="footer__qr-code-text">Yükləmək üçün kameranı QR-koda yönəldin</span></div>
        </div>
    </div>
    <div class="footer__blk footer__blk--thin footer__top">
        <div class="tz-container tz-d-flex tz-align-center tz-justify-between"><a target="_blank"
                data-stat="advertising-landing-footer-btn" class="footer__link" href="/pages/advert">Reklam
                yerləşdirin</a>
            <div class="footer__contacts tz-d-flex tz-align-center"><a target="_blank"
                    class="footer__contacts-i footer__contacts-i--facebook"
                    href="https://www.facebook.com/www.turbo.az"><svg class="footer__contacts-i__icon"
                        fill="#8D94AD" height="20" viewBox="0 0 10 21" width="12"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M2.148 4.059v2.885H.034v3.528h2.114v10.485H6.49V10.473h2.914s.273-1.692.405-3.542H6.507V4.519c0-.36.473-.846.941-.846h2.366V0H6.597c-4.557 0-4.45 3.532-4.45 4.059z"
                            fill-rule="evenodd"></path>
                    </svg></a><a target="_blank" class="footer__contacts-i footer__contacts-i--instagram"
                    href="https://www.instagram.com/turbo.az/"><svg class="footer__contacts-i__icon" fill="#8D94AD"
                        height="20" viewBox="0 0 21 21" width="20" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M14.744 0H6.256A6.263 6.263 0 0 0 0 6.256v8.488A6.263 6.263 0 0 0 6.256 21h8.488A6.263 6.263 0 0 0 21 14.744V6.256A6.263 6.263 0 0 0 14.744 0zm4.143 14.744a4.143 4.143 0 0 1-4.143 4.143H6.256a4.143 4.143 0 0 1-4.143-4.143V6.256a4.143 4.143 0 0 1 4.143-4.143h8.488a4.143 4.143 0 0 1 4.143 4.143v8.488zM10.5 5.069A5.437 5.437 0 0 0 5.069 10.5a5.438 5.438 0 0 0 5.431 5.431 5.438 5.438 0 0 0 5.431-5.431A5.437 5.437 0 0 0 10.5 5.069zm0 8.75a3.319 3.319 0 1 1 0-6.638 3.319 3.319 0 0 1 0 6.638zm5.442-7.408a1.301 1.301 0 1 0 0-2.603 1.301 1.301 0 0 0 0 2.603z"
                            fill-rule="evenodd"></path>
                    </svg></a>
                <div class="footer__contacts-i footer__contacts-i--mail"><svg class="footer__contacts-i__icon"
                        fill="#8D94AD" height="14" width="18" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M1.726 4.333c.228.159.914.63 2.058 1.413 1.144.784 2.02 1.387 2.63 1.81.067.047.209.147.426.303.218.155.398.281.542.377.144.096.318.203.522.322.204.119.397.208.577.268.181.06.348.089.502.089h.02c.154 0 .322-.03.502-.09.181-.059.374-.148.578-.267.204-.119.378-.226.521-.322.144-.096.325-.222.543-.377.217-.156.36-.256.426-.303l4.698-3.223a4.74 4.74 0 0 0 1.224-1.22c.328-.476.492-.975.492-1.498 0-.436-.16-.81-.477-1.12a1.56 1.56 0 0 0-1.13-.467H1.607C1.09.028.694.2.416.544.14.888 0 1.318 0 1.834c0 .416.184.867.552 1.353.368.486.76.868 1.174 1.146z">
                        </path>
                        <path
                    ...
                    </svg><a class="footer__link" href="mailto:turbo@turbo.az">turbo@turbo.az</a></div>
                <div class="footer__contacts-i footer__contacts-i--phone"><svg class="footer__contacts-i__icon"
                    ...
                    </svg><a class="footer__link footer__link--phone" href="tel:+994125057755">(012) 505-77-55</a>
                </div>
            </div>
        </div>
    </div>
    <div class="footer__bottom footer__blk footer__blk--thin footer__blk--red">
        <div class="tz-container tz-d-flex tz-align-center tz-justify-between">
            <div class="footer__responsibility">Saytın Administrasiyası reklam bannerlərinin və yerləşdirilmiş
                elanların məzmununa görə məsuliyyət daşımır.</div>
            <div class="tz-d-flex tz-align-center">
                <div class="footer__copyright">2006-2024 Digital Classifieds MMC. VÖEN: 1405631661</div><a
                    class="footer__mobile" rel="nofollow" href="/?mobile_site=1">Mobil versiyası</a>
            </div>
        </div>
    </div>
</footer>
