                    ...
                    <div class="tz-container tz-d-flex tz-align-center tz-justify-between">
                        ...
                        <div class="product-heading__right tz-d-flex tz-align-center">
                            ...
                            <div class="product-report">
                                <a class="product-report__btn js-product-report-btn"
                                   data-reported-text="Şikayət etmisiniz"
                                    ...
                                    <div class="product-vin__left">
                                        <div class="tz-d-flex tz-align-center tz-justify-between">
                                            ...
                                            <div class="product-vin__copy">
                                                ...
                                                <div class="product-vin__copy-text js-copy-copied is-hidden">Copied
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="product-shop">
                                    ...
                                    <div class="product-phones tz-mt-15">
                                        <div class="product-phones__btn js-phones-click-btn" data-log-show-phone="true"
                                            ...
                                            <div class="product-phones__btn-value"><a
                                                    href="tel:{{$adminSettings->phone ?? ''}}"
                                                    style="color: #fff;text-decoration: none">{{$adminSettings->phone ?? ''}}</a>
                                            </div>
                                        </div>
                ...
                <div class="tz-container">
                    <div class="section-title">
                        <p class="section-title_name">Similar ads</p><a class="section-title_more" target="_blank"
                                                                        href="/autos?q%5Bmake%5D%5B%5D=14-lexus&amp;q%5Bmodel%5D%5B%5D=134">Show
                            all</a>
                    </div>
                    <div class="products">
        ...
        <form action="{{ route('report') }}" class="simple_form default-form new_report" id="new_report" method="post">
            ...
            <div class="report-modal__content">
                ...
                <div class="input text optional report_body">
                    <textarea required rows="1" class="text optional form-control js-body-input"
                              data-title="Şikayəti təsvir edin"
                              placeholder="Describe the complaint max:400" name="description"
            ...
            <div class="report-modal__footer">
                <button type="submit" data-disable-with=""
                        class="tz-btn tz-btn--blue tz-btn--full tz-btn--spinner js-auth-iframe-link">Send
                </button>
            </div>
        </form>
    </div>
